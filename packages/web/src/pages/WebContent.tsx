      ...
      <div className="col-span-12 col-start-1 mx-2 lg:col-span-10 lg:col-start-2 xl:col-span-10 xl:col-start-2">
        {showError && (
          <Alert
            ...
            An error occurred while accessing the specified URL. Scraping may be prohibited or the URL might be incorrect. If you think it's a temporary issue, please try again.
          </Alert>
        )}

        <Card label="Website to extract content from">
          ...
          <div className="text-xs text-black/50">
            Please specify a website where text is the main content, such as blogs, articles, or documents. Otherwise, it may not output correctly.
          </div>
          ...
          <ExpandableField label="Additional Context" optional>
            <Textarea
              placeholder="You can enter additional points you want to be considered (e.g., summarize)"
              value={context}
              onChange={setContext}
            />
          </ExpandableField>
          ...
          <ExpandableField
            label={`Text before extraction (${
              fetching ? 'Loading...' : text === '' ? 'Not retrieved' : 'Retrieved'
            })`}
            className="mt-2">
            <div className="rounded border border-black/30 p-1.5">
              {text === '' && (
                <div className="text-gray-500">
                  Not retrieved. Please enter a URL and press the execute button.
                </div>
              )}
              {text}
              <div className="flex w-full justify-end">
