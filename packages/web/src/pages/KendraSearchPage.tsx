  ...
  return (
   <div className="flex flex-col items-center">
      ...
      <div className="text-sm text-gray-600">
        <div>
          This feature performs searches using the Query API, which is a standard feature of Amazon Kendra.
          <span className="font-bold">
            It does not use generative AI. RAG can be executed in the
