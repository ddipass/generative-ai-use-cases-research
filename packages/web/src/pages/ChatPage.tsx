...
const ChatPage: React.FC = () => {
  ...
  const title = useMemo(() => {
    if (chatId) {
      return getConversationTitle(chatId) || 'Chat';
    } else {
      return 'Chat';
    }
  ...
  return (
    <>
      ...
      <ModalDialog
        ...
        <div className="py-2.5">System Context</div>
        <Textarea
          placeholder={saveSystemContext ?? 'Please Enter'}
      ...
      <ModalDialog
        ...
        <div className="py-3 text-xs text-gray-600">
          {share ? (
            <>You can stop sharing the conversation by deleting the link.</>
          ) : (
            <>
